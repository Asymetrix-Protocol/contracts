...
describe("BinarySearchLibHarness", () => {
  ...
  before(async () => {
    ...
    binarySearchLibHarnessFactory = await ethers.getContractFactory("BinarySearchLibHarness");
  });

  beforeEach(async () => {
    binarySearchLibHarness = await upgrades.deployProxy(binarySearchLibHarnessFactory, []);
  });
