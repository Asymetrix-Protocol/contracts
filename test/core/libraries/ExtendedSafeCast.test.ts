...
describe("ExtendedSafeCastLib", () => {
  ...
  describe("toUint104()", () => {
    ...
    it("should fail to return value if value passed does not fit in 104 bits", async () => {
      ...
      await expect(ExtendedSafeCastLib.toUint104(value)).to.be.revertedWith("SafeCast: value doesn't fit in 104 bits");
    });
  });
  ...
  describe("toUint208()", () => {
    ...
    it("should fail to return value if value passed does not fit in 208 bits", async () => {
      ...
      await expect(ExtendedSafeCastLib.toUint208(value)).to.be.revertedWith("SafeCast: value doesn't fit in 208 bits");
    });
  });
  ...
  describe("toUint224()", () => {
    ...
    it("should fail to return value if value passed does not fit in 208 bits", async () => {
      ...
      await expect(ExtendedSafeCastLib.toUint224(value)).to.be.revertedWith("SafeCast: value doesn't fit in 224 bits");
    });
  });
});
