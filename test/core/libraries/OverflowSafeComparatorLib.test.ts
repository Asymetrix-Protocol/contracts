...
describe("overflowSafeComparatorLib", () => {
  ...
  describe("lt()", () => {
    it("should compare timestamp a to timestamp b if no overflow", async () => {
      ...
      expect(await overflowSafeComparatorLib.ltHarness(timestampA, timestampB, currentTimestamp)).to.equal(true);
    });
    ...
    it("should return false if timestamp a is equal to timestamp b", async () => {
      ...
      expect(await overflowSafeComparatorLib.ltHarness(timestampA, timestampB, currentTimestamp)).to.equal(false);
    });
  ...
  describe("lte()", () => {
    it("should compare timestamp a to timestamp b if no overflow", async () => {
      ...
      expect(await overflowSafeComparatorLib.lteHarness(timestampA, timestampB, currentTimestamp)).to.equal(true);
    });
    ...
    it("should compare timestamp a to timestamp b if b has overflowed", async () => {
      ...
      expect(await overflowSafeComparatorLib.lteHarness(timestampA, timestampB, currentTimestamp)).to.equal(false);
    });
  ...
  describe("checkedSub()", () => {
    ...
    it("should handle overflow of a", async () => {
      ...
      expect(await overflowSafeComparatorLib.checkedSub(firstTimestamp, secondTimestamp, firstTimestamp)).to.equal(
