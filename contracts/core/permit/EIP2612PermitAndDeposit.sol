...
/// @title Allows users to approve and deposit EIP-2612 compatible tokens into a
///        prize pool in a single transaction.
contract EIP2612PermitAndDeposit is Initializable {
    ...
    /**
     * @notice Permits this contract to spend on a user's behalf and deposits
     *         into the prize pool.
     * @dev The `spender` address required by the permit function is the address
     *      of this contract.
